...
The catalogue ships **28 themes** (12 default + 16 extra), the extras including a Dark category (Pine, Charcoal, Dusk, Plum, Abyss, Espresso) and five multi-colour themes (Rainbow, Pastel, Tropical, Autumn, Jewel). The counts are pinned by `apps/live/lib/themes.test.ts` and cited in [spec/09](09-canvas-and-palette.md), [spec/16](16-marketing-site.md), and [spec/23](23-marketing-assets.md); all four move together.
