...
Below it, nine top-level **view tabs** switch between ways of reading the single `GET /api/telemetry/summary` payload, ordered as a product funnel (who arrives, what they open + make, what they build, how they get unstuck, how machines connect, then the power-user lenses). On mobile the tab row **wraps** rather than overflowing a single line; Search and Raw sit last:
