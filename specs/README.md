...
| 61  | [Public API and API tokens](61-public-api-and-tokens.md)           | Proposed: API tokens for external callers + an HMAC requirement on X-Owner-Id to close a current owner-impersonation escalation; input hardening shipped |
