...
function ToggleTile({
  ...
  return (
    <button
      ...
      onClick={onToggle}
      className={`relative flex w-full flex-col items-center justify-start gap-0.5 rounded-md px-0.5 py-1.5 transition ${
        isFavourite
          ? 'bg-brand-50/70 text-slate-700 ring-1 ring-brand-200 hover:bg-brand-50 dark:bg-brand-500/10 dark:text-slate-200 dark:ring-brand-500/30 dark:hover:bg-brand-500/15'
