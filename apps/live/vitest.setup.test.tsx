...
// ever drops vitest.setup.ts, renders leak across tests again and React work
// scheduled on an orphaned root wakes after the jsdom teardown. That failure
// is a load-dependent CI flake; this is the cheap deterministic version of it.
