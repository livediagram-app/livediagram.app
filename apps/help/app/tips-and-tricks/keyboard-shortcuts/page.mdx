...
- **Shift while move-dragging a selection** drops a duplicate: the dragged elements land where you release and fresh copies stay behind at the origin, all in one undo step.
