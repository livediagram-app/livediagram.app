...
- **Access:** a token has your account's full read + write access to diagrams and folders, including your [teams'](/help/collaboration/teams/) shared libraries. It can't **manage** teams (invites, roles, joining) or your account — those need you signed in to the app. There is no read-only option yet.
