...
- **Access:** a token has your account's full read + write access to diagrams and folders, including your [teams'](/help/collaboration/teams/) shared libraries. It can't **manage** teams (invites, roles, joining) or your account: those need you signed in to the app. Tokens created on this page are always full read-write; a token minted when you [connect an AI tool](/help/account-and-data/connect-ai-mcp/) can be read-only if you tick that option on the consent screen, and such tokens show a **Read-only** badge in the list here.
