...
<Tip>
  Auto-Align is safe to run often. Since running it again changes nothing and it never moves
  anything far, it's a low-risk way to keep a diagram looking tidy as you work.
</Tip>
