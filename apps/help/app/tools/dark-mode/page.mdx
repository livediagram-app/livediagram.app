...
export const metadata = helpMetadata({
  ...
  description:
    'Flip the editor between light and dark with the sun/moon toggle. It recolours the editor chrome, not your diagram, and your choice is remembered.',
  path: '/help/tools/dark-mode/',
});

<ArticleLayout
  title="Light and Dark Mode"
  description="A light/dark toggle for the editor chrome, separate from your diagram's theme, so you can work comfortably in either."
  categoryTitle="Tools"
  categorySlug="tools"
>
...
The most important thing to know is what the toggle changes, and what it does not. UI mode recolours the **editor chrome**, the tab bar, header, panels, and the backdrop around your work. It does **not** touch the diagram itself: your canvas keeps whatever [theme](/help/customisation/themes/) you gave it.
