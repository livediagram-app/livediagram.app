...
The most important thing to know is what the toggle changes, and what it does not. UI mode recolours the **editor's interface**, the tab bar, header, panels, and the backdrop around your work. It does **not** touch the diagram itself: your canvas keeps whatever [theme](/help/customisation/themes/) you gave it.
