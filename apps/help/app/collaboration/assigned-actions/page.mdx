...
Anyone can assign an action to **themselves** — signed in or not — so actions also work as personal to-dos on a diagram. Assigning to other people is built on teams: for a diagram in a [team's shared library](/help/collaboration/teams/team-shared-diagrams/), the picker offers that team's joined members — the people who can actually open the diagram to complete the action. A personal diagram is self-assign only; move it into a team library to hand work to teammates.
