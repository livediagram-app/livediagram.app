...
<Step n={3}>
  They get an email letting them know, with a link to their Invites page. (If email isn't configured
  on the deployment, the invite still lands in their in-app Invites section — just tell them out of
  band as well.)
</Step>
