...
The **Image gallery** lives in the Explorer's **Library** section and collects every image you have uploaded. It is the companion to placing [images](/help/palette/images/) on the canvas: the canvas is where you use them, and the gallery is where you manage them.
