...
- **Tools:** pick up the Hand, Eraser, Format painter, Highlighter, Laser, Spotlight, Avatar or Isometric mode without opening the palette. Type "laser" and you get the laser, not just the article about it. The tool you are already holding isn't offered, everything except Select and Hand needs something on the canvas, Spotlight is desktop-only, and the two that can change the diagram (Eraser and Format painter) are withheld in a read-only view.
