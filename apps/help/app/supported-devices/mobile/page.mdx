...
On a small screen the floating panels are replaced by a **compact dock** in the top corner. Tap a dock button to open the palette, the Explorer, the Collaborate list (it appears once the tab has comments or actions), or other panels as a pop-over, and it tidies itself away again after you add something, so you keep the most room for your work.
