...
<Step n={3}>
  Right-click the entity and open **Fields** to edit the rows: a name, an optional type, a
...
<Tip>
  Entities are ordinary elements underneath, so a colour scheme recolours them, the format painter copies
