...
- **Shift-drag a selected arrow's head** to fork: the arrow stays put and a new branch starts attached to its line, ready to drag to a second target, the quickest way to make one trunk point at several places.
