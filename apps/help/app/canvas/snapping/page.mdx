...
On an [event storming board](/help/canvas/event-storming-boards/#timeline-lanes), holding the key is also the one way to put a note **between two lanes**: without it, a note always lands on the nearest lane.
