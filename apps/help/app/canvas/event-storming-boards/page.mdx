...
- **Notes are written in capitals.** Type however you like — the board paints it in caps, the way a marker on paper does. It stays readable from across the room and the wall reads as one hand rather than eight. Your typed wording is what is saved, so a note you export or search for keeps the capitals you actually used.
