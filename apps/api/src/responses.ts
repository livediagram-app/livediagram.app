...
export const CORS_HEADERS = {
  ...
  'Access-Control-Allow-Headers':
    'Authorization, Content-Type, X-Owner-Id, X-Owner-Sig, X-Share-Code, X-Share-Password, X-Allow-Empty, X-Image-Sha256, X-Image-Width, X-Image-Height, X-Image-Original-Name',
