    ...
    items: [
      {
        ...
        title: 'Forty-seven starter templates',
        description:
          'Mind maps (radial, tree, and bubble), org charts, retrospectives, flowcharts — plus swimlane, decision-tree, approval, and data-flow variants — Kanban, roadmaps, user story maps, affinity maps, RACI matrices, SWOT, empathy maps, Business Model Canvases, funnels, timelines (plain, plus horizontal and vertical milestone), Gantt, Venn, user journeys, fishbone, pyramids, OKR trees, sitemaps, flywheels, prioritization matrices, comparison tables, storyboards, ER / sequence / class / state-machine / system- and cloud-architecture diagrams, logo design, a live card, a to-scale floor plan, and mobile / laptop / web-page / slide-deck wireframes. Pick one, edit it, or start blank.',
      },
      {
        art: <ThemesArt />,
