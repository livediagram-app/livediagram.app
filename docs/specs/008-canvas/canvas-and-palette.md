...
Snapping during the drag considers all sixteen anchors of every shape on the canvas, so an arrow drag from a midpoint can still snap to and pin at a corner or a quarter point ([Arrow anchors and auto-rebind](arrow-anchors.md)).
