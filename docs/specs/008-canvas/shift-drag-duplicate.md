...
- Shift keeps its existing meaning on RESIZE drags (aspect constraint);
  ...
  drags (Shift there chains arrows, [Canvas and palette](canvas-and-palette.md)).

## Telemetry

`Element / Duplicated / ShiftDrag` ([Telemetry + public transparency dashboard](../017-telemetry/telemetry.md)).
...
(Settings' Keyboard category, [User preferences](../007-editor/user-preferences.md)) beside the other drag modifiers.

## References

[Canvas and palette](canvas-and-palette.md) (drag machinery, duplicate),
