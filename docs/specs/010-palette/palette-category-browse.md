# Browsing the palette by category
...
answering that in different ways. Tools drilled in ([Canvas and palette](../008-canvas/canvas-and-palette.md) "Sub-categories");
...
Both tabs emit the pair the Tools tab already did ([Telemetry + public transparency dashboard](../017-telemetry/telemetry.md)): `UI·Opened` with
