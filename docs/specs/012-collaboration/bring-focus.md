...
([Avatar mode](../008-canvas/avatar-mode.md)). Follow Me ([Follow-me viewport](follow-me-viewport.md))
...
shape as the poll prompt ([The lane](../009-elements/lane.md)), because it is a question addressed to them
