# Resync without reloading the page
...
Reconnect catch-up ([Realtime conflict resolution](realtime-conflict-resolution.md), Level 1) is scoped by an `epoch` + a monotonic
