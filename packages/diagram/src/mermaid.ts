...
// The export direction (mermaidFromTab and its shape-bracket table) lives in
// './mermaid-serialise'. Re-exported here so the package barrel and every
// existing import resolve exactly as before.
export { mermaidFromTab } from './mermaid-serialise';
