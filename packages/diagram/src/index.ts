...
// Arrow flow reuses the shared animation-speed scale. Type-only import
// from the animation LEAF module (which imports nothing), re-exported in
// full lower down via `export * from './animation'`.
