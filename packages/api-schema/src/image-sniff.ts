...
// label bytes whose stored type is missing. Pure and worker-safe, so both
// workers share the one signature table.

import type { AcceptedImageType } from './image-limits';
