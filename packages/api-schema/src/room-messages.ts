...
export type ServerMessage =
  ...
  // Who holds the facilitator baton (spec/147), broadcast on every change and
...
export type ClientMessage =
  // `facilitatorToken` (spec/147) is the baton coming home after a refresh:
  ...
  | { kind: 'op'; op: unknown }
  // Ask the room to move the baton (spec/147). The room decides; the client
