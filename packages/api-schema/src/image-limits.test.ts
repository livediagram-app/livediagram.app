...
// api's enforcement, the editor's pre-upload gate, docs/specs/009-elements/images.md, and the help
...
describe('MAX_IMAGE_BYTES', () => {
  ...
  it('stays under the Workers request-body ceiling docs/specs/009-elements/images.md relies on', () => {
    // docs/specs/009-elements/images.md justifies the cap partly by sitting "well below the Workers
