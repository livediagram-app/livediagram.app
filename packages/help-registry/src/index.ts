...
export const articles: Article[] = [
  ...
  },
  {
    ...
    keywords:
      'feed activity history what happened whats new latest events log stream notifications updates recent changes calendar month view upcoming expiring stacked grouped collapse day colour color red amber green deleted preview thumbnail card cards grid menu ellipsis rename move duplicate created updated unread unseen new badge since last visit who did what other people filter local time remove dismiss hide clutter tidy clean up refresh live update',
    category: 'Explorer',
    categorySlug: 'explorer',
  },
  {
